...
export class FixtureController {
  ...
  @ApiOperation({
    ...
    description:
      'This endpoint retrieves all upcoming sports, categories and tournaments based on a specified period of time',
  })
  // @ApiQuery({ type: SwaggerSportMenuRequest})
  @ApiOkResponse({ type: SwaggerSportMenuResponse })
  GetSportsMenu(@Query() query: SwaggerSportMenuRequest) {
    try {
