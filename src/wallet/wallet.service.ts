...
import { BranchRequest,
  ...
  ExpenseSingleResponse,
        ...
        GetTransactionsRequest} from '../interfaces/wallet.pb';
import { ClientGrpc } from '@nestjs/microservices';
import { firstValueFrom } from 'rxjs';
import { EmptyRequest } from 'src/interfaces/identity.pb';
...
export class WalletService {
    ...
    async getMoneyTransactions(data: GetTransactionsRequest): Promise<CommonResponseObj> {
